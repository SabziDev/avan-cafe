  ...
  return cardVariant === "vertical" ? (
    <article className="flex-items-center h-100 w-70 flex-col justify-between rounded-3xl p-4 shadow-[0_0_6px_rgba(0,0,0,0.1)] md:w-85">
      <div className="flex-center flex-col">
        <Img src={data.imgSrc} alt="blog-card" className="h-45 w-65 md:w-70" />
    ...
    <article className="flex-items-center h-47.5 w-175 justify-between gap-10 rounded-3xl p-4 shadow-[0_0_6px_rgba(0,0,0,0.1)]">
      <Img src={data.imgSrc} alt="blog-card" className="h-35 w-80" />
